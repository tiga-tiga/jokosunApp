                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  items[index].status == 'PENDING'
                                      ...
                                      : items[index].status == 'FINISHED' ? SizedBox(): Center(
                                          child: RaisedButton.icon(
                                              shape: RoundedRectangleBorder(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                              ...
                                              icon: Icon(
                                                  ...
                                                  color: Colors.green),
                                              label: Text( items[index].status == 'CHECKLIST' ?
                                                "Démarrer l'installation" : "Continuer l'installation",
                                                style: smallBoldTextStyle(
                                                    Colors.green),
                                              )),
                                        ),
